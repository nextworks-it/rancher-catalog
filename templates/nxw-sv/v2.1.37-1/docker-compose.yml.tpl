...
# ----------
  ...
  nxw-sv:
    ...
    security_opt:
      - seccomp:unconfined
    image: docker-registry.nextworks.it/nxw-sv:2.1.37-1
    restart: on-failure
    stdin_open: true
    network_mode: host
    hostname: supervisor
...
# ----------
  ...
  panels-factory-be:
    image: docker-registry.nextworks.it/panels-factory-be:v1.0.36
    restart: on-failure
...
# ----------
  ...
  alarm-manager:
    image: docker-registry.nextworks.it/alarm-manager:v0.17.5
    restart: on-failure
    network_mode: host
    # dns points to dnrd on nxw-sv, which runs in network nost mode
    dns: 127.0.0.1
...
# --------
  ...
  favo:
      image: docker-registry.nextworks.it/favo:v0.34.6
      #hostname: favo
      environment:
...
# --------
  ...
  avo:
      image: docker-registry.nextworks.it/avo:v0.31.11
      #hostname: avo
      environment:
...
# --------
  ...
  av-cfg-fe:
      image: docker-registry.nextworks.it/av-cfg-fe:v1.6.6
      environment:
        ETCD_SERVICE_HOST: nxw-sv
        ETCD_SERVICE_PORT: '2379'
        PPROF_ENABLED: 'false'
