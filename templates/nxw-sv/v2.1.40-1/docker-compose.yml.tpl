...
# ----------
  ...
  nxw-sv:
    ...
    security_opt:
      - seccomp:unconfined
    image: docker-registry.nextworks.it/nxw-sv:2.1.40-1
    restart: on-failure
    stdin_open: true
    network_mode: host
    hostname: supervisor
...
# ----------
  ...
  panels-factory-be:
    image: docker-registry.nextworks.it/panels-factory-be:v1.0.38
    restart: on-failure
...
# --------
  ...
  avo:
      image: docker-registry.nextworks.it/avo:v0.31.16
      #hostname: avo
      environment:
