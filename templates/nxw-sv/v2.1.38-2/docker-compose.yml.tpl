...
# ----------
  ...
  nxw-sv:
    ...
    security_opt:
      - seccomp:unconfined
    image: docker-registry.nextworks.it/nxw-sv:2.1.38-1
    restart: on-failure
    stdin_open: true
    network_mode: host
    hostname: supervisor
...
# ----------
  ...
  panels-factory-be:
    image: docker-registry.nextworks.it/panels-factory-be:v1.0.37
    restart: on-failure
...
# --------
  ...
  favo:
      image: docker-registry.nextworks.it/favo:v0.34.7
      #hostname: favo
      environment:
...
# --------
  ...
  avo:
      image: docker-registry.nextworks.it/avo:v0.31.13
      #hostname: avo
      environment:
