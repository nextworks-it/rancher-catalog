...
# ----------
  ...
  nxw-sv:
    ...
    security_opt:
      - seccomp:unconfined
    image: docker-registry.nextworks.it/nxw-sv:2.0.40-1
    restart: on-failure
    stdin_open: true
    network_mode: host
    hostname: supervisor
...
# ----------
  ...
  plinsky:
    image: "docker-registry.nextworks.it/plinsky:v0.4.8"
    network_mode: host
...
# ----------
  ...
  tex-server:
    image: docker-registry.nextworks.it/template-expander:v0.1.2
    restart: on-failure
...
# --------------
  ...
  chrono-manager:
    image: docker-registry.nextworks.it/chrono-manager:v0.99.22
    restart: on-failure
