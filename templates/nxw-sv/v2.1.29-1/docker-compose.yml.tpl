...
# ----------
  ...
  nxw-sv:
    ...
    security_opt:
      - seccomp:unconfined
    image: docker-registry.nextworks.it/nxw-sv:2.1.29-1
    restart: on-failure
    stdin_open: true
    network_mode: host
    hostname: supervisor
...
# --------
  ...
  analytic:
    image: docker-registry.nextworks.it/analytic:v0.1.21
    restart: on-failure
    network_mode: managed
    #ports:
    #  - '8058:8058'
...
# --------
  ...
  avo:
      image: docker-registry.nextworks.it/avo:v0.31.3
      #hostname: avo
      environment:
...
# --------
  ...
  av-cfg-fe:
      image: docker-registry.nextworks.it/av-cfg-fe:v1.5.0
      environment:
        ETCD_SERVICE_HOST: nxw-sv
        ETCD_SERVICE_PORT: '2379'
        PPROF_ENABLED: 'false'
