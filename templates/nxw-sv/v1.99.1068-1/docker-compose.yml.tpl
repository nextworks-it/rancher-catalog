...
# ----------
  ...
  nxw-sv:
    ...
    security_opt:
    - seccomp:unconfined
    image: docker-registry.nextworks.it/nxw-sv:1.99.1068-1
    restart: on-failure
    stdin_open: true
    network_mode: host
    hostname: supervisor
...
# ----------
  ...
  tex-server:
    image: docker-registry.nextworks.it/template-expander:v0.0.7
    restart: always
...
# ----------
  ...
  channel-manager:
    image: docker-registry.nextworks.it/channel-manager:v0.9.127
    dns: 169.254.169.250
    environment:
      - CHANNEL_MANAGER_SERVICE_HOST=channel-manager
      - ETCD_SERVICE_HOST=nxw-sv
